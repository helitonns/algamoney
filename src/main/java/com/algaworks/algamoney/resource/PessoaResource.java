...
public class PessoaResource {
    ...
    @PutMapping("/{codigo}")
    @PreAuthorize("hasAuthority('ROLE_CADASTRAR_PESSOA')")
    public ResponseEntity<Pessoa> atulizar(@PathVariable Long codigo, @Valid @RequestBody Pessoa pessoa) {
    ...
    public Page<Pessoa> pesquisar(@RequestParam(required = false, defaultValue = "%") String nome, Pageable pageable) {
        return pessoaRepository.findByNomeContaining(nome.toUpperCase(), pageable);
    }
}
